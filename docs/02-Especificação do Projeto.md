...
|RF-009| O sistema deve permitir que o usuário visualize os materiais com base em rankings de popularidade da comunidade.| ALTA |
|RF-010| O sistema deve permitir que o usuário compartilhe listas de leitura personalizadas (ex: "Bibliografia Essencial de Direito", "Novas Aquisições da Biblioteca").| MEDIA |
|RF-011| O sistema deve permitir que o usuário personalize seu perfil, adicionando a informação de área de estudo para facilitar conexões com outros usuários.| MEDIA | 
|RF-012| O sistema deve permitir a criação de grupos de estudo sobre tópicos específicos, facilitando a conexão entre alunos com os mesmos interesses dentro das comunidades.| MEDIA |
...
|RF-017| O sistema deve permitir que o usuário crie listas de leitura personalizadas (ex: "Bibliografia Essencial de Direito", "Novas Aquisições da Biblioteca").| MEDIA |
|RF-018| O sistema deve permitir que o usuário visualize os materiais pelas melhores avaliações da comunidade.| ALTA |
|RF-019| O sistema deve permitir que o usuário personalize seu perfil, adicionando a informação de trilha de conhecimento para facilitar conexões com outros usuários.| MEDIA | 
|RF-020| O sistema deve permitir que o usuário personalize seu perfil, adicionando a informação de projetos aos quais participa para facilitar conexões com outros usuários.| MEDIA | 
|RF-021| O sistema deve permitir a busca por grupos de estudo sobre tópicos específicos, facilitando a conexão entre alunos com os mesmos interesses dentro das comunidades.| MEDIA |
...
|RNF-006| A plataforma deve seguir as diretrizes do WCAG (Web Content Accessibility Guidelines) 2.1, nível AA, garantindo o acesso para pessoas com deficiência (ex: compatibilidade com leitores de tela, navegação por teclado e contraste de cores adequado).| Acessibilidade |  MÉDIA | 
|RNF-007| A arquitetura do sistema deve ser capaz de suportar um crescimento de 50% no número de usuários e de conteúdo por ano, sem degradação significativa no desempenho.| Escalabilidade |  MÉDIA | 
|RNF-008| O código-fonte e a arquitetura da plataforma devem ser bem documentados e modulares para facilitar futuras atualizações, correções de bugs e a implementação de novas funcionalidades.| Manutenibilidade |  MÉDIA | 
...
<img width="1080" height="720" alt="UML" src="img/Diagrama de caso de uso(Revisado 2).png" />
